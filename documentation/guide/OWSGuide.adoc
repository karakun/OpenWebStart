...
TIP: On MacOS, application shortcuts are also added to the Launchpad.
If you want to remove some or all of these shortcuts you have to delete the corresponding files in the `<User Home>/Applications` directory.
