...
This may lead to overwriting of shortcut of one application by the shortcut of another application with the same title or jnlp file name.
...
* _Unique Name_: Create unique names for shortcuts to prevent name clash.
